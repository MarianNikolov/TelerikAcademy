namespace RowsFromCategoriesTable
{
    ...
    public class Task
    {
        ...
        public void Start()
        {
            //// Important - Check connection string below
            SqlConnection dataBaseConnection =
                new SqlConnection("Server=PCLenovo; Database=northwind; Integrated Security=true");
            dataBaseConnection.Open();

            using (dataBaseConnection)
            {
                //// Important - Each method below is one task execute them one by one 
                //this.ShowCountOfRowsFromCategories(dataBaseConnection);
                //this.GetColumsFromCategories(dataBaseConnection);
