...
namespace _02
{
    class MoreOptimization
    {
        ...
        public static void Mainaaaaaaaaaaaaaaaaaaaaaaa1()
        {
            var startRow = 0;
            var startCol = 0;
            ...
            int[,] matrixResults = new int[rowSize, colSize];
            ...
            for (int row = 0; row < rowSize; row++)
            {
                ...
                {
                    matrix[row, col] = 1;
                    matrixResults[row, col] = int.MaxValue;
                }
            }
            ...
            Solver(startRow, startCol, matrix, isVisited, matrixResults);
